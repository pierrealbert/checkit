<?php
	...
	$mcImageManagerConfig['filesystem.rootpath'] = $_SERVER['DOCUMENT_ROOT'] . '/media/upload'; // absolute or relative from this script path, required.
	...
	$mcImageManagerConfig['thumbnail.jpeg_quality']     = 90; // quality of th image, note that this is not checked against when regenerating ths.
	...
	$mcImageManagerConfig['upload.max_width'] = "480"; // Only if force_width_height is true
