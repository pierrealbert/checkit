...
**************************************************************************
*************************************************************************/
(function($){$.fn.jRating=function(op){
    var defaults={
    ...
    if(this.length>0)return this.each(function(){
        ...
        var average=parseFloat($(this).attr('data-average')),
            ...
            quotient=$('<div>',{'class':'jRatingColor',css:{width:widthColor}}).appendTo($(this)),
            average=$('<div>',{'class':'jRatingAverage',css:{width:widthColor,top:-starHeight}}).appendTo($(this)),
        ...
        if(!jDisabled)
            $(this).unbind().bind({
                ...
                click:function(e){
                    ...
                    if(opts.sendRequest){
                        $.post(opts.phpPath,{idBox:idBox,rate:rate,action:'rating'},function(data){
                            if(!data.error){
